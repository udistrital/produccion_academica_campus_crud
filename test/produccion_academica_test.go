...
func run_bee() {
	parametros := "API_PRODUCCION_ACADEMICA_HTTP_PORT=" + beego.AppConfig.String("httpport") + " PRODUCCION_ACADEMICA_CAMPUS_CRUD__PGUSER=" + beego.AppConfig.String("PGuser") + " PRODUCCION_ACADEMICA_CAMPUS_CRUD__PGPASS=" + beego.AppConfig.String("PGpass") + " PRODUCCION_ACADEMICA_CAMPUS_CRUD__PGURLS=" + beego.AppConfig.String("PGurls") + " PRODUCCION_ACADEMICA_CAMPUS_CRUD__PGDB=" + beego.AppConfig.String("PGdb") + " PRODUCCION_ACADEMICA_CAMPUS_CRUD__SCHEMA=" + beego.AppConfig.String("PGschemas") + " bee run"
